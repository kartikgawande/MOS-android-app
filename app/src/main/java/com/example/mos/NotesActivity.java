...
//
//public class NotesActivity extends AppCompatActivity implements GoogleDriveUtils.OnDriveUpdatedLocalDBlistener {
//
...
//        });
//
////        new GoogleDriveUtils(this); //this is important dont delete //uncomment this if u again want to use NotesActivity.java
//
//        if (ContextCompat.checkSelfPermission(NotesActivity.this, Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED) {
...
//                        try {
//                            Drive googleDriveService = GoogleDriveUtils.getDriveService(NotesActivity.this,intentData);
...
//        );
//
//        GoogleSignInClient client = GoogleDriveUtils.signInGoogleAndGetClient(NotesActivity.this);
...
//                Intent addNoteActIntent = new Intent(NotesActivity.this, AddNoteActivity.class);
...
//        dbHelper = new SQLiteDbHelper(NotesActivity.this);
...
//        notesIntent.putExtra(SOURCE, NOTES_ACTIVITY);
//        sendBroadcast(notesIntent);
//        Intent eyeCareIntent = new Intent(this, EyeCareReceiver.class);
//        eyeCareIntent.putExtra(SOURCE, NOTES_ACTIVITY);
